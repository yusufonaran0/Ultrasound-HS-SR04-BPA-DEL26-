...
module measurement_control (
    ...
    // Updated for hardware implementation. :)))
    // 250 ms waiting interval between two measurements at 100 MHz:
    // 100_000_000 Hz * 0.250 s = 25_000_000 clock cycles
    localparam integer MEAS_INTERVAL_CYCLES = 25_000_000;
    ...
    reg [24:0] interval_counter; // for 0..25,000,000
